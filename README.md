...
**UPD: 11.07.2023**
Исправлен 5-й пункт и частично 6-й.
...
2. В боте реализована логика, предназначенная для работы с одним юзером. А именно, при запуске /restart или /start переменные, используемые в логике, "обнуляются", что приводит к багу. Дабы не быть голословным, вот следующая ситуация:
