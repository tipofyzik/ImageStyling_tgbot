...
2. Для запуска бота по своему API скачайте **всю директорию "tgbot"**.

Запуск бота происходит при помощи файла **"app.py"**. В файле


Ниже приведены мои комментарии касательно процесса создания этого бота, обоснования выбора сети и небольшая демонстрация результата.
