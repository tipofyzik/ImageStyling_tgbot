...
## 3. Докер и деплой
Создание докер-контейнера и его последующее размещение на сервере реализовано на ПО Docker https://ru.wikipedia.org/wiki/Docker. Давайте поближе посмотрим на реализацию:
