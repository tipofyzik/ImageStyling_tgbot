...
При написании бота возникли некоторые ошибки. В конце этого раздела будут даны ссылки на решения для каждой проблемы. Отмечены они будут как в ноутбуке "Ошибка [номер]".
