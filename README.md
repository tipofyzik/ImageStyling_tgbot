...
**MSG-Net имеет следующие преимущества** перед другими аналогами (CycleGan или Deep Photo Style Transfer) в задаче переноса стиля с одного изображения на другое:
  ...
  3. И самое главное - она не такая ресурсоёкая, как та же Deep Photo Style Transfer, что, как следствие, даёт относительно быструю скорость обработки изображений и позволяет задеплоить сеть на бесплатных ресурсах.
