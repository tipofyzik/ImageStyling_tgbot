...
5. У бота есть ограничение - не реализован многопользовательский режим, так как это не являлось основной задачей. Бот рассчитан лишь на одного пользователя. Если 2 или более юзера буду пользовать ботом одновременно оригинальное изображение и изображение стиля будут перезаписываться и результат будет представлять собой обработку последних 2х загруженных фотографий.
